...
CUDA_VISIBLE_DEVICES=0,1,2,3 nohup torchrun --master_port 10088 --nproc_per_node 4 main_imagenet.py -a resnet18_1w1a_recu --dali_cpu \
-save imagenet_birealnet_recu_benchmark_lr=${lr}_wd=${wd}_K=${K}_S=${S}_L=${L}_lr-decay=${lr_decay}_epochs=200  --wd ${wd} --lr ${lr} \
