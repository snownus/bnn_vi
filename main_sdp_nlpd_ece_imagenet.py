...
def calculate_nlpd(y_true, y_pred_probs, epsilon=1e-10):
    """
...
def main():
    ...
    if args.evaluate:
        nlpd, ece = validate(val_loader, model, criterion)
        print(f'nlpd: {nlpd} \t ece: {ece}')
        return
...
def validate(val_loader, model, criterion):
    ...
    for i, data in enumerate(data_iterator):
        ...
        # print(f'output shape: {output.shape}, {output[0]}')
