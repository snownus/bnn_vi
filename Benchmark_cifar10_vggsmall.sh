...
do
  ...
  CUDA_VISIBLE_DEVICES=$GPU_id nohup python main_sdp1_wo_gaussian_qudrature.py --model vgg_small_cifar10_sdp \
  --save vgg_small_cifar10_seed=${seed}_benchmark_K=${K}_S=${S}_L=${L}_wd=${wd}_lr=${lr}_cos_epochs=600 \
