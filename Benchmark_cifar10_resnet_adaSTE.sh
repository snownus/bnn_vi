...
do
  ...
  nohup python main_sdp1_wo_gaussian_qudrature.py --model resnet18_1w32a\
  --save resnet18_1w32a_cifar10_seed=${seed}_benchmark_K=${K}_S=${S}_L=${L}_wd=${wd}_lr=${lr}_cos_epochs=600\
