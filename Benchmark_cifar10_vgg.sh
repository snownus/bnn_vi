...
do
  ...
  nohup python main_sdp1_wo_gaussian_qudrature.py --model vgg_cifar10_sdp \
  --save vgg_cifar10_seed=${seed}_benchmark_K=${K}_S=${S}_L=${L}_milestones=60_120_180 \
  --dataset cifar10 --binarization  det --wd ${wd} --lr ${lr} \
