...
class BiRealNet(nn.Module):
    ...
    def __init__(self, block, layers, K, scale, num_classes=1000, zero_init_residual=False):
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        layers = []
        layers.append(block(self.K, self.scale, self.inplanes, planes, stride, downsample))
        self.inplanes = planes * block.expansion
        for _ in range(1, blocks):
            layers.append(block(self.K, self.scale, self.inplanes, planes))
