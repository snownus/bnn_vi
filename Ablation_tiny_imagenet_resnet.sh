...
do
  ...
  nohup python main_sdp1_wo_gaussian_qudrature.py --model resnet_binary_sdp \
  --save resnet_tiny_imagenet_seed=${seed}_benchmark_K=${K}_S=${S}_L=${L}_lr=${lr}_milestones=60_120_180 \
